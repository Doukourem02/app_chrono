package com.fleetbase.mapboxnavigation
...
class MapboxNavigationView(private val context: ThemedReactContext, private val accessToken: String?) :
    ...
    fun onCreate() {
        ...
        // Patch Krono : app utilisée exclusivement en Côte d'Ivoire -> français forcé
        // (au lieu de Locale.US.language qui faisait parler la navigation en anglais).
        // Miroir du patch iOS (MapboxNavigationView.swift: options.locale = Locale(identifier: "fr_FR")).
        ...
        try {
            mapboxNavigation.requestRoutes(
                RouteOptions.builder()
                    ...
                    // Patch Krono : force le français pour les instructions de manœuvre (bannière),
                    // indépendamment de la locale système du téléphone du livreur.
                    .language("fr")
