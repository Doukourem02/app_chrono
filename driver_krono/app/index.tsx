...
export default function RootIndex() {
  ...
  useEffect(() => {
    ...
    const checkSession = async () => {
      // Charger le refresh token depuis SecureStore AVANT tout check (comme app_krono)
      await hydrateTokens();
    ...
    // Attendre que le persist Zustand ait rechargé user/isAuthenticated (comme app_krono)
