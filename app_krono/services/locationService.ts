 ...
 * Reverse geocoding : Mapbox (priorité) > Nominatim > Expo - aligné avec admin_krono
 */
...
class LocationService {
   ...
   * Mapbox donne des adresses précises (ex: Rue Panama City, 772) comme admin_krono
   */
  async reverseGeocode(coords: LocationCoords): Promise<string | null> {
    ...
    // 1. Mapbox en priorité (aligné admin_krono)
