...
Cette bibliothèque de composants d'animations utilise `react-native-reanimated` et `expo-haptics` pour créer des expériences utilisateur fluides et engageantes.
