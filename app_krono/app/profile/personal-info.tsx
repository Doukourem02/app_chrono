  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (result.success && result.data) {
        ...
        console.warn('[app_krono/personal-info] updateProfile success:false', { userId: user.id, message: msg });
      ...
      console.warn('[app_krono/personal-info] updateProfile exception', error);
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity
          ...
          disabled={isLoading}
          accessibilityRole="button"
          accessibilityLabel="Enregistrer les informations personnelles"
