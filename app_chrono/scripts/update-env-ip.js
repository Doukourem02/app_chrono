...
function updateEnvFile(ip) {
  // Obtenir le chemin du dossier app_chrono
  // process.cwd() retourne le répertoire depuis lequel le script est exécuté
  // Quand on fait "npm run update-ip", cwd est le dossier app_chrono
  ...
  if (!fs.existsSync(envPath)) {
    ...
    console.log('💡 Créez d\'abord un fichier .env dans le dossier app_chrono');
    process.exit(1);
  }
