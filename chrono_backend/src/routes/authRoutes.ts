...
import {registerUserWithPostgreSQL,loginUserWithPostgreSQL,checkUserInPostgreSQL,getAllUsersFromPostgreSQL,sendOTPCode,verifyOTPCode,refreshToken,updateUserProfile,getUserProfile,uploadAvatar,} from '../controllers/authController.js';
