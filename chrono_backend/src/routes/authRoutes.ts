...
import {registerUserWithPostgreSQL,loginUserWithPostgreSQL,checkUserInPostgreSQL,checkUserByIdInPostgreSQL,getAllUsersFromPostgreSQL,sendOTPCode,verifyOTPCode,refreshToken,updateUserProfile,getUserProfile,uploadAvatar,} from '../controllers/authController.js';
