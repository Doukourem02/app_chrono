...
import {registerUserWithPostgreSQL,loginUserWithPostgreSQL,checkUserInPostgreSQL,checkUserByIdInPostgreSQL,getAllUsersFromPostgreSQL,sendOTPCode,verifyOTPCode,refreshToken,logoutUser,updateUserProfile,getUserProfile,uploadAvatar,} from '../controllers/authController.js';
...
router.post('/logout', verifyJWT, validateRefreshToken, logoutUser);
router.get('/check-by-id/:userId', verifyJWT, checkUserByIdInPostgreSQL);
router.get('/check/:email', verifyJWT, checkUserInPostgreSQL);
