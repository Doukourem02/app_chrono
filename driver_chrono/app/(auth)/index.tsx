...
/** Une seule entrée téléphone + OTP — nouveau ou existant, traité après le code. */
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      if (msg.includes('trop de temps')) {
        logger.warn('Envoi OTP : délai dépassé (API joignable ? EXPO_PUBLIC_API_URL / IP machine).', 'PhoneAuth', msg);
      } else {
        logger.error('Erreur envoi OTP chauffeur', 'PhoneAuth', error);
      }
