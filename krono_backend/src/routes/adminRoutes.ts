...
import { getAdminDriverDetails, updateAdminDriverStatus, getAdminDrivers, getAdminDriverFullDetails, rechargeAdminDriverCommission, suspendAdminDriverCommission, updateAdminDriverCommissionRate, bulkUpdateAdminDriverCommissionRate, getAdminDriverCommissionTransactions } from '../controllers/adminDriverController.js';
import { getAdminUsers, getAdminClientDetails, getAdminClientStatistics, getAdminAdminDetails, updateStaffRole, createAdminMinimalClient } from '../controllers/adminUserController.js';
...
router.post('/clients/minimal', verifyAdminSupabase, createAdminMinimalClient);
...
router.put('/drivers/:driverId/commission/rate', verifyAdminSupabase, requireSuperAdmin, updateAdminDriverCommissionRate);
router.put('/drivers/commission/rate/bulk', verifyAdminSupabase, requireSuperAdmin, bulkUpdateAdminDriverCommissionRate);
...
router.post('/promo-codes', verifyAdminSupabase, requireSuperAdmin, createAdminPromoCode);
