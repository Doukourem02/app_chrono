...
/**
 * API route pour obtenir les données de performance analytics
...
export async function GET(request: NextRequest) {
  try {
    ...
    const backendUrl = `${API_BASE_URL}/api/analytics/performance?days=${days}`
    ...
    console.error('Error in analytics/performance API:', errorMessage)
    return NextResponse.json(
